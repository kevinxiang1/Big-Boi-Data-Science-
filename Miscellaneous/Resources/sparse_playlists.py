...
def main():
	...
	TRUNC_AMOUNT = 10000 #this controls how many top songs you want to keep in truncation
	...
	# np.save('lookup_table.txt', np_lookup_table)
	...
	similar, largestPair, smallestPair, top_similars\
		= utils.most_similar(lookup_table, vocab['Shape of You'], NUM_CLOSEST)
